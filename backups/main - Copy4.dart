// main.dart (FULL UPDATED FILE - Excel errors fixed)
// -----------------------------------------------------------------------------
// Changes in THIS version:
// 1. Removed dependency on the 'excel' package (which caused your build errors).
// 2. Added a REAL Excel-compatible export without extra packages using
//    XML Spreadsheet 2003 format (.xls). Excel opens it fine.
// 3. File export names now use format: dive_log_YYYY_MM_DD_HHMM.*
/*    Example: dive_log_2025_10_09_0052.csv and dive_log_2025_10_09_0052.xls */
// 4. Kept CSV export.
// 5. SHOW DIVERS team buttons display "BLUE TEAM", etc. (already applied).
// 6. Responsive scaling kept.
// 7. Alert grammar + green "All divers are OUT" kept.
// 8. Aquacoulisse screen centering & true top-left back button retained.
// 9. Immediate history updates + dive duration remain.
// -----------------------------------------------------------------------------
//
// If later you still want native XLSX (OpenXML), add a real package. For now,
// this .xls (XML 2003) export will work in Excel without extra dependencies.
//
// -----------------------------------------------------------------------------
// NOTE: Dependencies still needed in pubspec.yaml (no 'excel' now):
//   share_plus: ^10.0.0
//   path_provider: ^2.1.2
// -----------------------------------------------------------------------------
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Container(
                            padding: EdgeInsets.symmetric(
                              vertical: isPhone ? 10 * scale : 24 * scale,
                              horizontal: 8 * scale,
                            ),
                            child: Column(
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      width: (isPhone ? 70 : 100) * scale,
                                      height: (isPhone ? 40 : 54) * scale,
                                      child: ElevatedButton(
                                        onPressed:
                                            (selectedDiver != null &&
                                                selectedTag != null)
