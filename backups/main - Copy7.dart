...
// - Renamed the top-right button text on the first and second screens and on
//   the third screen header from "History" to "  Log  " (two spaces on each side)
//   so the button keeps a wider touch target without changing styles.
// - All other functionality remains unchanged:
//   * Team buttons (Show Divers) highlight in their own team color.
//   * Team buttons hidden after a diver is selected (when choosing tags).
//   * If selected diver is currently IN, tag UI is hidden (only OUT is needed).
//   * AQUACOULISSE spelling in titles, 4x5 tag grid on large screens.
//   * Enlarged IN/OUT buttons, exports, alerts, dark mode, etc.
// -----------------------------------------------------------------------------
