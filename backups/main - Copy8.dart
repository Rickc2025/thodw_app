// main.dart (Deck Operator: keep selection across team/department switches)
// - Removed selectedDivers.clear() when tapping team or department filter buttons.
// - Selection now persists while browsing all filters.
// Other features: tags for all departments, operator IN/OUT for all departments,
// log highlighting, etc.
                        ...
                        ElevatedButton(
                          onPressed: () {
                            setState(() {
                              ...
                              selectedTeam = t;
                              // DO NOT clear selectedDivers here (keep selection)
                            });
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
